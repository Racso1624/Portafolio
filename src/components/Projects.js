...
[Youtube, "Youtube Clon", "https://github.com/Racso1624/Proyecto1_Web", "Project Made with Javascript, Webpack and Sass"],
...
[Calculator, "Calculator", "https://github.com/Racso1624/Laboratorio8_Calculadora", "Project Made with Javascript and Webpack for testing"], 
...
const Projects = () =>(
    <div className="projects" id="projects">
        <div className="projects-content">
            ...
            {
                projects_list.map((element, index) =>{
                    return <ProjectCard key={index} logo={element[0]} name={element[1]} link={element[2]} description={element[3]}/>
                })
            }
        </div>
        </div>
